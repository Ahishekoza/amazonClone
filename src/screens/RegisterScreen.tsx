      ...
      <KeyboardAvoidingView>
        ...
        <View style={{ marginTop: 70 }}>
          <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#D0D0D0', columnGap: 5, paddingVertical: 2, borderRadius: 5, marginTop: 30 }}>
            <UserIcon style={{ marginLeft: 8 }} size={24} color={'grey'} />
            <TextInput value={formData.name} onChangeText={(text) => setFormData({ ...formData, name: text })} style={{ width: 300, color: 'gray', marginVertical: 5 }} placeholder='Enter your Name' />
          </View>
          <View style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: '#D0D0D0', columnGap: 5, paddingVertical: 2, borderRadius: 5, marginTop: 30 }}>
        ...
        <View style={{ marginTop: 70 }}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Login')}>
            <Text style={{ textAlign: 'center', fontSize: 20, marginTop: 10 }}>Already have account ? Sign In</Text>
          </TouchableOpacity>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
